...
@section('content')
    ...
    @endphp
    <x-adminlte-button style="margin-bottom: 10px" label="Create" icon="fas fa-plus" theme="success" onclick="window.location.href='{{ route('showtimes.create') }}'" />
            ...
            <tr>
                ...
                <td>
                    <nobr style="display: flex; flex-direction: row">
                        <button class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit" onclick="window.location.href='{{ route('showtimes.edit', $showtime) }}'">
