...
@section('content')
    <form action="{{ route('showtimes.update', $showtime) }}" method="post">
        ...
        <div class="form-group d-flex justify-content-between" style="width: max-content !important; gap: 50px;">
            <div class="form-group d-flex flex-column justify-content-between">
                ...
                <div class="input-group date" id="starttimepicker" style="width: max-content !important;"
                    ...
                    <input name="start_time" type="text" class="form-control datetimepicker-input" value="{{ $showtime->start_time }}"
            ...
            <div class="form-group d-flex flex-column justify-content-between">
                ...
                <div class="input-group date" id="endtimepicker" style="width: max-content !important;"
                    data-target-input="nearest">
                    <input name="end_time" type="text" class="form-control datetimepicker-input" value="{{ $showtime->end_time }}"
        ...
        <x-adminlte-button type='submit' label='Update' theme="success" icon="fas fa-pen"></x-adminlte-button>
    </form>
@endsection
