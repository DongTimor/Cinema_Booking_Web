...
<body>
    <div style="max-width: 600px; margin: 0 auto; border: 1px solid #ccc; background-color: #f9f9f9;">
                ...
                <td style="padding: 20px; border-bottom: 1px solid #ccc;">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: start;">{{ $request->customer }}</td>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: end">
                                {{ $request->voucher["code"] }} ({{ $request->voucher['type'] == 'percent' ? $request->voucher['value'] . '%' : $request->voucher['value'] . ' VND' }})
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <a href="#" style="width: 100%; margin-top: 20px; display: inline-block; background-color: #5c2d91; color: white; text-decoration: none; border-radius: 5px; text-align: center;">DOWNLOAD</a>
