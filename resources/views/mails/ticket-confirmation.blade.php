                ...
                <td style="padding: 20px; border-bottom: 1px solid #ccc;">
                    ...
                    <table style="width: 100%; margin-top: 10px;">
                        <tr>
                            ...
                            <td style="text-align: end;">{{ $request->total * $count }} VND</td>
                        </tr>
                    </table>
                </td>
            </tr>
                ...
                <td style="padding: 20px; border-bottom: 1px solid #ccc;">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: end">{{ $request->event_discount * $count }} VND</td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: end">
                                @if ($request->voucher != null)
                                    ...
                                    {{ $request->voucher['type'] == 'percent'
                                        ? $request->voucher['value'] * (1/100) * $request->total * $count . ' VND'
                                        : $request->voucher['value'] * $count . ' VND' }}
                                @else
                                    None
                                @endif
                            </td>
                ...
                <td style="padding: 20px; border-bottom: 1px solid #ccc;">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: end;">{{ $request->cost * $count }} VND</td>
                        </tr>
                    </table>
                </td>
            </tr>
